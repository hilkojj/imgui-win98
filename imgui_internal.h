...
namespace ImGui
{
    ...
    IMGUI_API bool          ImageButtonEx(ImGuiID id, ImTextureID texture_id, const ImVec2& size, const ImVec2& uv0, const ImVec2& uv1, const ImVec2& padding, const ImU32 bg_col, const ImU32 tint_col, ImGuiButtonFlags flags = 0);

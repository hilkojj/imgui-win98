...
enum ImGuiButtonFlags_
{
    ...
    ImGuiButtonFlags_NoOutline              = 1 << 22,
...
public:
    ...
    float       TitleBarHeight() const  { ImGuiContext& g = *GImGui; return (Flags & ImGuiWindowFlags_NoTitleBar) ? 0.0f : CalcFontSize() + g.Style.FramePadding.y * 2.0f + 4.0f; }
...
namespace ImGui
{
    ...
    IMGUI_API bool          BeginChildEx(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags, float BgTopOffset = 0.0f);
    ...
    IMGUI_API void          RenderFrame(ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, bool border = true, float rounding = 0.0f, bool bInset = true);
    ...
    IMGUI_API bool          ImageButtonEx(ImGuiID id, ImTextureID texture_id, const ImVec2& size, const ImVec2& uv0, const ImVec2& uv1, const ImVec2& padding, const ImU32 bg_col, const ImU32 tint_col, ImGuiButtonFlags flags = 0, const ImU32* active_tint_col = nullptr);

...
namespace ImGui
{
    ...
    IMGUI_API bool          ImageButton(ImTextureID user_texture_id, const ImVec2& size, const ImVec2& uv0 = ImVec2(0, 0),  const ImVec2& uv1 = ImVec2(1,1), int frame_padding = -1, const ImU32 bg_col = 0u, const ImU32 tint_col = 0u, ImGuiButtonFlags flags = 0);    // <0 frame_padding uses default frame padding settings. 0 for no padding
